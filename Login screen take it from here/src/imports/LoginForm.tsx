...
function Frame1() {
  return (
    <button className="bg-[#2580d3] box-border content-stretch cursor-pointer flex flex-col gap-[4.818px] h-[26px] items-center justify-center px-[14.934px] py-[4.336px] relative rounded-[4.336px] shrink-0 w-[66px]">
      <Frame />
    </button>
  );
}
