import svgPaths from "./svg-a91rn2qcgp";
  ...
  return (
    <div className="relative size-full" data-name="Desktop Login Landing Page">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[120px] py-[200px] relative size-full">
          <LoginForm />
        </div>
      </div>
    </div>
