...
$start_year = mysqli_real_escape_string($connection, $_POST['year']);
$start_month = mysqli_real_escape_string($connection, $_POST['month']);
...
?>
    ...
    ?>
                ...
                <div class="golden-ratio bg-sales" style="height: 608px;">
                    ...
                    <div class="text-middle">
                        <div class="d-flex align-content-center align-items-center justify-content-center">
                            ...
                            <span class="fs-24"><?php echo $currencySymbol . formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $SalesValue)); ?></span>
                        </div>
                    ...
                    <div class="golden-ratio bg-variable-expense" style="width: 100%;height: 132px;">
                        ...
                        <div class="text-middle">
                            <div class="d-flex align-content-center align-items-center justify-content-center">
                                ...
                                <span class="fs-24"><?php echo $currencySymbol . formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $VariableExpenseValue)); ?></span>
                            </div>
                            <div class="d-inline-flex align-content-center align-items-center">
                        ...
                        <div class="bar-golden-ratio yellow">
                            ...
                            <span class="golden-ratio"><?php echo number_format($VariableExpenseRatio, 2); ?>%</span>
                        </div>
                    </div>
                </div>
                <div class="d-flex">
                    <div class="p-1">
                        <div class="golden-ratio bg-gross-profit" style="width: 284px;height: 468px;">
                            <div class="text-top-right">
                                <button class="btn btn-sm btn-light px-4 border py-0" type="button">Gross Profit</button>
                            </div>
                            <div class="text-middle" style="top:30%">
                                <div class="d-flex align-content-center align-items-center justify-content-center">
                                    ...
                                    <span class="fs-24"><?php echo $currencySymbol . formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $GrossProfitValue)); ?></span>
                                </div>
                                <div class="d-inline-flex align-content-center align-items-center">
                            ...
                            <div class="bar-golden-ratio green" style="top:65%">
                                <div class="mx-1 icon-forecast-accounts green">M</div>
                                Gross Profit Ratio
                    ...
                    <div class="w-100">
                        <div class="p-1">
                            <div class="golden-ratio bg-labor-cost" style="width: 100%;height: 270px;">
                                    ...
                                    <div class="d-table w-100">
                                        <div class="d-table-cell align-content-center" style="justify-items: center;">
                                            <div class="d-flex align-content-center align-items-center justify-content-center">
                                                ...
                                                <span class="fs-24"><?php echo $currencySymbol . formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $FixedExpenseValue)); ?></span>
                                            </div>
                                            <div class="d-inline-flex align-content-center align-items-center">
                                        ...
                                        <div class="d-table-cell border-start border-warning" style="justify-items: center;">
                                ...
                                <div class="bar-golden-ratio pink" style="top:80%">
                                    ...
                                    <span class="golden-ratio"><?php echo number_format($BreakEventPointRatio, 2); ?>%</span>
                                </div>
                            ...
                            <div class="golden-ratio bg-operating-profit" style="width: 100%;height: 190px;">
                                ...
                                <div class="text-middle">
                                    <div class="d-flex align-content-center align-items-center justify-content-center">
                                        ...
                                        <span class="fs-24"><?php echo $currencySymbol . formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $OperatingProfitValue)); ?></span>
                                    </div>
                                    <div class="d-inline-flex align-content-center align-items-center">
                                ...
                                <div class="bar-golden-ratio green" style="width: 364px;    transform: translate(-94%, -50%);">
        ...
        <div class="d-flex justify-content-center p-1">
            <button class="btn btn-md btn-light px-4 border py-0" type="button">Time period : <?php echo date("F Y", strtotime($start_year . '-' . $start_month . '-01')); ?></button>
        </div>
    <?php
    } else {
    ?>
