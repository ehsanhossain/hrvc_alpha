                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center mb-3 justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-sm btn-light fs-13 me-2" onclick="exportExcel();">Download Flow <i class="bi bi-file-earmark-arrow-down"></i></a>
                            </div>

                            <div class="d-flex align-items-center">
                                <select name="MajorId" id="MajorId" class="filter me-2" onchange="getMedium('MediumId')">
                                    <option value="">All Catagory</option>
                                </select>
                                <select name="MediumId" id="MediumId" class="filter me-2">
                                    <option value="">All Sub-Catagory</option>
                                </select>
                                <select name="BreakdownId" id="BreakdownId" class="filter me-2">
                        ...
                        <div id="formRegisterCurrency" class="p-4 form-currency">
                            <div class="position-relative dash-forecast-accounts" style="height: 55vh;">
                                <div class="position-middle content-no-config">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="getModalCreate();">
                                    ...
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modalImport">
                    ...
                    <div class="configuration-browse">
                            ...
                            <tr>
                                <td>
                                    <div class=" d-table position-relative">
                                        ...
                                        <img src="../asset/images/Drag and Drop Icon.png" alt="" width="94">
                        ...
                        <div class="text-center fs-12 mt-3">
                            ...
                            <div class="mt-3" id="boxFileImport">
                                <img src="../asset/images/excel.png" alt="Excel Icon" style="width: 100px;">
