...
$sql_branch = "SELECT a.*,b.*,c.countryName,c.flag,MIN(e.year) AS min_year
FROM branch a 
                ...
                <div class="card-body ">
                    <div class="d-flex align-items-center mb-3 justify-content-between">
                        <div class="d-flex align-items-center">
                            <div class="me-2"><img src="https://tcg-hrvc-system.com/<?php echo $row_branch['branchImage']; ?>" alt="" class="dd-circle"></div>
                            <div>
                                <div class="fs-16 fw-500"><?php echo $row_branch['branchName']; ?></div>
                                <div class="d-flex align-items-center">
                                    <img src="https://tcg-hrvc-system.com/<?php echo $row_branch['flag']; ?>" alt="" class="dd-flag me-1">
                                    <div class="fw-400 fs-12"><?php echo $row_branch['countryName']; ?>,<?php echo $row_branch['city']; ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="fw-600 fs-16">FY <?php echo $start_year; ?></div>
                    </div>
                            ...
                            <div class="rounded bg-white p-3">
                                ...
                                <table class="table fs-14 fw-500 mt-2">
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <?php echo getStatusBadge($last_year_status); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Current Progress</td>
                                        <td class="text-end">
                                            <?php echo getStatusBadge($actual_status); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Current Year Target</td>
                                        <td class="text-end">
                                            <?php echo getStatusBadge($target_status); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Next Year’s Target</td>
                                        <td class="text-end">
                                            <?php echo getStatusBadge($next_target_status); ?>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="col-lg-3 col-12 mb-3 mb-lg-0 d-lg-table-cell d-block align-bottom px-0">
                            <div class="mb-2 fs-14">
                                <span class="text-primary">
                                    ...
                                    <a href="FinancialConfiguration?id=<?php echo $branchId; ?>">Configuration</a>
                                </span>
                            </div>
                            <div class="mb-2 fs-14">
                                <span class="text-primary">
                                    ...
                                    <a href="FinancialProfitLossPortal?id=<?php echo $branchId; ?>">P&L Forecast</a>
                                </span>
                            </div>
                            <div class="mb-2 fs-14">
                                <span class="text-danger" style="cursor: pointer;" onclick="deleteBranch('<?php echo $branchId; ?>')">
