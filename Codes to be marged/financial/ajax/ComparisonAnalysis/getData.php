            ...
            <div class="col-lg-4 mb-3 p-3">
                <div class="card chart">
                    <div class="card-body title">
                        <span class="label-title label-info me-2">PL</span> <?php echo $listHead[$i]['breakdown']; ?>
                    </div>
                    <div class="card-body">
                        <div class="bar-container">
                            <div class="label"><span class="label-title label-red me-2">LP</span> <?php echo $startYear - 1; ?></div>
                            <div class="bar">
                                <div class="bar-inner red" style="width: <?php echo round($row_detail['percent_accum_last_act']); ?>%;"></div>
                            </div>
                            <div class="percentage"><?php echo round($row_detail['percent_accum_last_act']); ?>%</div>
                        </div>
                        <div class="bar-container">
                            <div class="label fw-400"><span class="label-title label-red me-2">CP</span> <?php echo $startYear; ?></div>
                            <div class="bar">
                                <div class="bar-inner green" style="width: <?php echo round($row_detail['percent_accum_act']); ?>%;"></div>
                            </div>
                            <div class="percentage"><?php echo round($row_detail['percent_accum_act']); ?>%</div>
                        </div>
                        <div class="bar-container">
                            <div class="label"><span class="label-title label-green me-2">CT</span> <?php echo $startYear; ?></div>
                            <div class="bar">
                                <div class="bar-inner yellow" style="width: <?php echo round($row_detail['percent_accum_tar']); ?>%;"></div>
                            </div>
                            <div class="percentage"><?php echo round($row_detail['percent_accum_tar']); ?>%</div>
                        </div>
                        <div class="bar-container">
                            <div class="label"><span class="label-title label-yellow me-2">NT</span> <?php echo $startYear + 1; ?></div>
                            <div class="bar">
                                <div class="bar-inner blue" style="width: <?php echo round($row_detail['percent_accum_next_tar']); ?>%;"></div>
                            </div>
                            <div class="percentage"><?php echo round($row_detail['percent_accum_next_tar']); ?>%</div>
                        </div>
                    </div>
                </div>
            </div>
