            ...
            <tbody>
                <?php for ($i = 0; $i < 12; $i++) : ?>
                    <tr class="upper m-<?php echo $i; ?> <?php echo $list_breakdown_data[$i]['breakdown_class']; ?>">
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['last_actual_amount'])); ?>
                        <td class="data-pl content-pl show" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['actual_amount'])); ?>
                        <td class="data-pl content-cp" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['target_amount'])); ?>
                        <td class="data-pl content-ct" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['next_target_amount'])); ?>
                        <td class="data-pl content-nt" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                    </tr>
                    <tr class="lower a-<?php echo $i; ?> <?php echo $list_breakdown_data[$i]['breakdown_class']; ?>">
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['accum_last_act'])); ?>
                        <td class="data-pl content-pl show" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['accum_act'])); ?>
                        <td class="data-pl content-cp" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['accum_tar'])); ?>
                        <td class="data-pl content-ct" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                        <?php $val = formatRateNumber($rate, changeCurrencyValue($currencyDefaul, $currencyFocus, $list_breakdown_data[$i]['data'][$key]['accum_next_tar'])); ?>
                        <td class="data-pl content-nt" <?php echo $val == '0' ? "style='font-weight:200;'" : ''; ?>><?php echo $val; ?></td>
                    </tr>
                <?php endfor; ?>
            </tbody>
