...
<div class="wrapper-content">
    ...
    <div class="mb-3 card-nav-tab justify-content-between">
        <ul class="card-tab ">
            ...
            <li><img src="../images/icons/Dark/48px/Golden-Ratio.png" style="height:20px"> Golden Ratio</li>
            <li><img src="../images/icons/Dark/48px/Designation-1.png" style="height:20px"> Forecast Accounts</li>
        </ul>
        <ul class="card-tab ">
            <li class="px-3"><img src="../image/logo-tcg.png" style="width:24px"> Tokyo Consulting Firm</li>
            <li class="px-3 fs-12 fw-300"><img src="../image/logo-tcg.png" style="width:24px"> Bangkok , Thailand</li>
        </ul>
                ...
                <div class="d-table w-100">
                    <div class="px-2 align-middle d-table-cell w-50">
                        ...
                        <div class="mb-4 d-flex align-items-center">
                            <div class="me-3"><img src="../asset/images/TCG-logo.png" alt="" class="dd-circle" style="width:87px;height:87px;"></div>
                            <div>
                    ...
                    <div class="px-2 align-middle d-table-cell w-50">
                        ...
                        <div class="input-date-finance-config">
                            <img src="../asset/icon/calendar-between.png" class="date">
