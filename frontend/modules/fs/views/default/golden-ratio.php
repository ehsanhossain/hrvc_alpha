...
$this->title = 'Golden Ratio — Finlytics';
...
<div class="finlytics-module">
    ...
    <div class="fl-tab-bar">
        ...
        <a href="<?= \yii\helpers\Url::to(['/fs/default/golden-ratio']) ?>" class="fl-tab active">
    ...
    <div class="fl-card" style="min-height:400px;display:flex;align-items:center;justify-content:center;">
        <div style="text-align:center;color:#8B8B8B;">
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none"><rect x="4" y="4" width="56" height="56" rx="4" stroke="#CBD5E1" stroke-width="2"/><rect x="4" y="4" width="35" height="35" rx="4" stroke="#CBD5E1" stroke-width="1.5"/><rect x="4" y="4" width="22" height="22" rx="4" stroke="#CBD5E1" stroke-width="1"/></svg>
            <p style="margin-top:16px;font-size:18px;font-weight:500;">Golden Ratio</p>
