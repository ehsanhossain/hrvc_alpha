...
<div class="wrapper-content">
    ...
    <div class="card-nav-tab justify-content-between">
        <ul class="card-tab ">
            ...
            <li class="active"><img src="/fs/images/icons/Dark/48px/Designation-1.png" style="width:18px"> Forecast Accounts</li>
        </ul>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3 justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="fs-20 me-2">Forecast Accounts</div>
                            </div>
                        </div>
                        ...
                        <div class="row-forecast-accounts mb-3">
                            <div class="widget-forecast-accounts">
                                <div class="box-forecast-accounts">
                                    <div class="title-forecast-accounts">
                                        <div class="icon-forecast-accounts blue">P</div>
                                        <div class="lh-1 ms-2">
                                            <div class="fs-16">Price</div>
                                            <div class="fs-12 fw-200">(Product Appeal)</div>
                                        </div>
                                    </div>
                                    <div class="detail-forecast-accounts">
                                        <table class="w-100">
                                            <tr>
                                                <td class="fw-200">Sensitivity ratio</td>
                                                <th class="text-end">56.0%</th>
                                            </tr>
                                            <tr>
                                                <td class="fw-200">Sensitivity Rank</td>
                                                <th class="text-end">1</th>
                                            </tr>
                                            <tr>
                                                <td class="fw-200">Strategic Rank</td>
                            ...
                            <div class="widget-forecast-accounts">
                                <div class="box-forecast-accounts">
                                    <div class="title-forecast-accounts">
                                        <div class="icon-forecast-accounts dark-blue">Q</div>
                                        <div class="lh-1 ms-2">
                                            <div class="fs-16">Price</div>
                                            <div class="fs-12 fw-200">(Product Appeal)</div>
                                        </div>
                            ...
                            <div class="widget-forecast-accounts">
                                <div class="box-forecast-accounts">
                                    <div class="title-forecast-accounts">
                                        <div class="icon-forecast-accounts red">F</div>
                                        <div class="lh-1 ms-2">
                                            <div class="fs-16">Price</div>
                                            <div class="fs-12 fw-200">(Product Appeal)</div>
                                        </div>
                            ...
                            <div class="widget-forecast-accounts">
                                <div class="box-forecast-accounts">
                                    <div class="title-forecast-accounts">
                                        <div class="icon-forecast-accounts yellow">V</div>
                                        <div class="lh-1 ms-2">
                                            <div class="fs-16">Price</div>
                                            <div class="fs-12 fw-200">(Product Appeal)</div>
                                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="bar-light  mb-3">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="me-2">Current Year</div>
                                            <select name="year" id="year" class="select-year px-2 me-2" style="width:auto;" onchange="getData();">
                                                <option value="">2024</option>
                                            </select>
                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" class="me-2">
                                                <path d="M11.3333 7.19267C8.76067 7.19267 6.66667 9.286 6.66667 11.8593C6.66667 14.418 8.76067 16.5 11.3333 16.5C13.906 16.5 16 14.4067 16 11.8333C16 9.27467 13.906 7.19267 11.3333 7.19267ZM11.3333 15.1667C9.49533 15.1667 8 13.6827 8 11.8593C8 10.0213 9.49533 8.526 11.3333 8.526C13.1713 8.526 14.6667 10.01 14.6667 11.8333C14.6667 13.6713 13.1713 15.1667 11.3333 15.1667ZM12.4713 12.0287C12.732 12.2893 12.732 12.7107 12.4713 12.9713C12.3413 13.1013 12.1707 13.1667 12 13.1667C11.8293 13.1667 11.6587 13.1013 11.5287 12.9713L10.862 12.3047C10.7367 12.1793 10.6667 12.01 10.6667 11.8333V10.5C10.6667 10.132 10.9647 9.83333 11.3333 9.83333C11.702 9.83333 12 10.132 12 10.5V11.5573L12.4713 12.0287ZM16 5.16667V6.5C16 6.868 15.702 7.16667 15.3333 7.16667C14.9647 7.16667 14.6667 6.868 14.6667 6.5V5.16667C14.6667 4.064 13.7693 3.16667 12.6667 3.16667H3.33333C2.23067 3.16667 1.33333 4.064 1.33333 5.16667V5.83333H7.33333C7.70133 5.83333 8 6.132 8 6.5C8 6.868 7.70133 7.16667 7.33333 7.16667H1.33333V13.1667C1.33333 14.2693 2.23067 15.1667 3.33333 15.1667H6C6.368 15.1667 6.66667 15.4653 6.66667 15.8333C6.66667 16.2013 6.368 16.5 6 16.5H3.33333C1.49533 16.5 0 15.0047 0 13.1667V5.16667C0 3.32867 1.49533 1.83333 3.33333 1.83333H4V1.16667C4 0.798667 4.29867 0.5 4.66667 0.5C5.03467 0.5 5.33333 0.798667 5.33333 1.16667V1.83333H10.6667V1.16667C10.6667 0.798667 10.9647 0.5 11.3333 0.5C11.702 0.5 12 0.798667 12 1.16667V1.83333H12.6667C14.5047 1.83333 16 3.32867 16 5.16667Z" fill="#3C3D48" />
                                            </svg>
                                            <div class="me-2">Current Month</div>
                                            <select name="month" id="month" class="select-year px-2 me-2" style="width:auto;" onchange="getData();">
                                                <?php
                                                $months = [
                                                    1 => "January",
                                                    2 => "February",
                                                ...
                                                ?>
                                                    <option value='<?php echo $num; ?>' <?php echo $num == intval(date('m')) ? 'selected' : ''; ?>><?php echo $name; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                            ...
                                            <select name="currencyId" id="currencyId" class="select-year px-2 me-2" style="width:auto;" onchange="getData();">
                                            </select>
                                        ...
                                        <div class="chart-tab-menu">
                                            ...
                                            <button class="menu-chart menu-tab active" type="button" data-id="#Monthly">Monthly</button>
                                            <button class="menu-chart menu-tab" type="button" data-id="#Annual">Annual</button>
                                            <button class="menu-chart menu-tab" type="button" data-id="#Comparison">Comparison</button>
                                        </div>
                                    </div>
                                </div>

                                <div class="chart-tab-content">
                                    <div class="tab-content show" id="Monthly">
                                        1
                                    </div>
                            ...
                            <div class="col-3">
                                <div class="bar-light mb-3 text-center">Future & Business Competitiveness Rank</div>

                                <div class="card-forecast-accounts" id="ss-class">
                                    <div class="desc-forecast-accounts">
                                        <div class="title-forecast-accounts">Super excellent company, has a great reserve of energy</div>
                                        <div class="metrics-forecast-accounts">
                                            <div>UNDER 60%<br><small>BEF Ratio</small></div>
                                            <div>OVER 1.66 times<br><small>Fixed Expense Productivity</small></div>
                                        </div>
                                    </div>
                                    <div class="rating-forecast-accounts">
                                        "SS"
                                    </div>
                                </div>

                                <div class="card-forecast-accounts" id="s-class">
                                    <div class="desc-forecast-accounts">
                                        <div class="title-forecast-accounts">Excellent company, has some reserve of energy</div>
                                        <div class="metrics-forecast-accounts">
                                            <div>60%~80%<br><small>BEF Ratio</small></div>
                                            <div>1.25~1.66 times<br><small>Fixed Expense Productivity</small></div>
                                        </div>
                                    </div>
                                    <div class="rating-forecast-accounts">
                                        "S"
                                ...
                                <div class="card-forecast-accounts" id="a-class">
                                    <div class="desc-forecast-accounts">
                                        <div class="title-forecast-accounts">Sound management company, has well competitiveness</div>
                                        <div class="metrics-forecast-accounts">
                                            <div>81%~90%<br><small>BEF Ratio</small></div>
                                            <div>1.1~1.24 times<br><small>Fixed Expense Productivity</small></div>
                                        </div>
                                    </div>
                                    <div class="rating-forecast-accounts">
                                        "A"
                                ...
                                <div class="card-forecast-accounts" id="b-class">
                                    <div class="desc-forecast-accounts">
                                        <div class="title-forecast-accounts">Breakeven point company, cannot be careless at all</div>
                                        <div class="metrics-forecast-accounts">
                                            <div>91%~100%<br><small>BEF Ratio</small></div>
                                            <div>1.0~1.99 times<br><small>Fixed Expense Productivity</small></div>
                                        </div>
                                    </div>
                                    <div class="rating-forecast-accounts">
                                        "B"
                                ...
                                <div class="card-forecast-accounts" id="c-class">
                                    <div class="desc-forecast-accounts">
                                        <div class="title-forecast-accounts">Deficit-ridden company, unsure future</div>
                                        <div class="metrics-forecast-accounts">
                                            <div>101%~200%<br><small>BEF Ratio</small></div>
                                            <div>0.5~0.99 times<br><small>Fixed Expense Productivity</small></div>
                                        </div>
                                    </div>
                                    <div class="rating-forecast-accounts">
                                        "C"
                                ...
                                <div class="card-forecast-accounts" id="d-class">
                                    <div class="desc-forecast-accounts">
                                        <div class="title-forecast-accounts">Deficit-ridden company, unsure future</div>
                                        <div class="metrics-forecast-accounts">
                                            <div>OVER 200%<br><small>BEF Ratio</small></div>
                                            <div>Under 0.5 times<br><small>Fixed Expense Productivity</small></div>
                                        </div>
                                    </div>
                                    <div class="rating-forecast-accounts">
                                        "D"
...
<script>
    ...
    function getData() {
        ...
        let tab = '';
        if (type == 1) {
            url = 'ajax/ForecastAccount/getMonthly.php';
            tab = 'Monthly';
        } else if (type == 2) {
            url = 'ajax/ForecastAccount/getAnnual.php';
            tab = 'Annual';
        } else if (type == 3) {
            url = 'ajax/ForecastAccount/getComparison.php';
            tab = 'Comparison';
        }
    ...
    function updateClass() {
        let financialClass = parseInt($('#financialClass').val());

        switch (financialClass) {
            case 1:
                $(".card-forecast-accounts").removeClass("yellow");
                $("#ss-class").addClass("yellow");
                break;
            case 2:
                $(".card-forecast-accounts").removeClass("yellow");
                $("#s-class").addClass("yellow");
                break;
            case 3:
                $(".card-forecast-accounts").removeClass("yellow");
                $("#a-class").addClass("yellow");
                break;
            case 4:
                $(".card-forecast-accounts").removeClass("yellow");
                $("#b-class").addClass("yellow");
                break;
            case 5:
                $(".card-forecast-accounts").removeClass("yellow");
                $("#c-class").addClass("yellow");
                break;
            case 6:
                $(".card-forecast-accounts").removeClass("yellow");
                $("#d-class").addClass("yellow");
                break;
        }
    }
</script>