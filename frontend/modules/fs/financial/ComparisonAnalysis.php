...
<link rel="stylesheet" href="/fs/plugins/apexcharts/dist/apexcharts.css">
<div class="wrapper-content">
    ...
    <div class="card-nav-tab justify-content-between">
        <ul class="card-tab ">
            <li class="active"><img src="/fs/images/icons/Dark/48px/PL-Forecast.png" style="width:18px"> PL Forcast</li>
            <li><img src="/fs/images/icons/Dark/48px/Golden-Ratio.png" style="width:18px"> Golden Ratio</li>
            <li><img src="/fs/images/icons/Dark/48px/Designation-1.png" style="width:18px"> Forecast Accounts</li>
        </ul>
...
<script src="/fs/plugins/apexcharts/dist/apexcharts.js"></script>
<script>
