                ...
                <div class="border-0 card" style="height: 240px;">
                    <div class="card-body">
                        <div class="mb-2 d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <button class="btn btn-sm btn-blue fs-13" onclick="window.location.href='/fs/default/currency-management';">
                                    Manage
    ...
    <form id="form_filer">
        <div class="popup-filter-content">
            <div class="d-flex justify-content-between">
                <div class="d-flex">
                    <img src="/fs/asset/images/filter.png" alt="" width="24">
                    <div class="fs-24 ps-2">Filter</div>
                </div>
                <div class="" onclick="$('#popupFilter').removeClass('active')">
                    <img src="/fs/asset/images/close-circle.png" class="popup-filter-close" alt="">
                </div>
            </div>
